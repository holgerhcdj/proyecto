...
<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{asset('img/logo.png')}}" width="30" height="30"
             alt="Almacen">
        <img class="navbar-brand-minimized" src="{{asset('img/logo.png')}}" width="30"
             height="30" alt="Coffe Mari">
    </a>
        ...
        <li class="nav-item dropdown">
            <a class="nav-link" style="margin-right: 10px" data-toggle="dropdown" href="#" role="button"
               aria-haspopup="true" aria-expanded="false">
                <strong>Usuario:</strong> {{ Auth::user()->per_usuario.' / '.$tipo }}
            </a>
...
<footer class="app-footer">
    <div>
        <a href="https://infyom.com">Almacen</a>
